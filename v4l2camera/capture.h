#ifndef __SC_CAPTURE_H_
#define __SC_CAPTURE_H_

/*refer to https://raw.githubusercontent.com/commshare/node-v4l2camera/master/capture.h*/
...
} camera_format_t;/*´ú±íÒ»¸ö¸ñÊ½*/

typedef struct {
  size_t length;
  camera_format_t* head;
} camera_formats_t; /*¸ñÊ½Á´±í*/
...
} camera_control_type_t; /*¿ÉÒÔÈç´ËÓÐÐ§µÄ¿ØÖÆcameraÃ´å*/
