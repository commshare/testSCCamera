...
#else
#define SLOGI(format,...)  fprintf(stderr,"[%s_%d_%s]"format"\n",__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)
#define SLOGD(format,...)  fprintf(stderr,"[%s_%d_%s]"format"\n",__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)
#define SLOGW(format,...)  fprintf(stderr,"[%s_%d_%s]"format"\n",__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)
#define SLOGE(format,...)  fprintf(stderr,"[%s_%d_%s]"format"\n",__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)
#endif
/*
#define HAL_INFO(fmt...) \
do{\
